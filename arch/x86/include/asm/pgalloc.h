...
static inline void paravirt_alloc_pte(struct pg_table *pgt, unsigned long pfn)	{}
...
extern pgtable_t pte_alloc_one(struct pg_table *);
...
static inline void _pmd_populate_kernel(struct pg_table *pgt,
				       pmd_t *pmd, pte_t *pte)
{
	paravirt_alloc_pte(pgt, __pa(pte) >> PAGE_SHIFT);
...
static inline void pmd_populate_kernel(struct mm_struct *mm,
				       pmd_t *pmd, pte_t *pte)
{
	_pmd_populate_kernel(&mm->pgt, pmd, pte);
}

static inline void _pmd_populate_kernel_safe(struct pg_table *pgt,
				       pmd_t *pmd, pte_t *pte)
{
	paravirt_alloc_pte(pgt, __pa(pte) >> PAGE_SHIFT);
...
static inline void pmd_populate_kernel_safe(struct mm_struct *mm,
				       pmd_t *pmd, pte_t *pte)
{
	_pmd_populate_kernel_safe(&mm->pgt, pmd, pte);
}

static inline void _pmd_populate(struct pg_table *pgt, pmd_t *pmd,
				struct page *pte)
{
	unsigned long pfn = page_to_pfn(pte);

	paravirt_alloc_pte(pgt, pfn);
...
extern void _pud_populate(struct pg_table *pgt, pud_t *pud, pmd_t *pmd);
#else	/* !CONFIG_X86_PAE */
...
static inline void _pud_populate_safe(struct pg_table *pgt, pud_t *pud, pmd_t *pmd)
{
	paravirt_alloc_pmd(pgt, __pa(pmd) >> PAGE_SHIFT);
...
{
	_pud_populate_safe(&mm->pgt, pud, pmd);
}
...
static inline void _p4d_populate(struct pg_table *pgt, p4d_t *p4d, pud_t *pud)
{
...
static inline void _p4d_populate_safe(struct pg_table *pgt, p4d_t *p4d, pud_t *pud)
{
	paravirt_alloc_pud(pgt, __pa(pud) >> PAGE_SHIFT);
...
{
	_p4d_populate_safe(&mm->pgt, p4d, pud);
}
...
static inline void _pgd_populate(struct pg_table *pgt, pgd_t *pgd, p4d_t *p4d)
{
