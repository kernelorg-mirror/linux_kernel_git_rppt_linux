...
{
	kfree((void *)(unsigned long)image->arch.pgd);
	image->arch.pgd = NULL;
#ifdef CONFIG_X86_PAE
	kfree((void *)(unsigned long)image->arch.pmd0);
	image->arch.pmd0 = NULL;
	kfree((void *)(unsigned long)image->arch.pmd1);
	image->arch.pmd1 = NULL;
#endif
	kfree((void *)(unsigned long)image->arch.pte0);
	image->arch.pte0 = NULL;
	kfree((void *)(unsigned long)image->arch.pte1);
